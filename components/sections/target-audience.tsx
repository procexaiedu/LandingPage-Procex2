...
const audiences = [
  {
    icon: Users,
    title: "Atende clientes o dia inteiro",
    description: "suporte, SAC, help desk, pré-venda, CS.",
    color: "from-blue-500/20 to-blue-500/5",
  },
  {
    icon: Zap,
    title: "Está sempre 'apagando incêndio'",
    description: "não consegue organizar a fila nem priorizar.",
    color: "from-amber-500/20 to-amber-500/5",
  },
  {
    icon: BarChart3,
    title: "Quer responder mais gente",
    description: "sem perder qualidade com a mesma equipe.",
    color: "from-green-500/20 to-green-500/5",
  },
  {
    icon: Shield,
    title: "Precisa de histórico melhor",
    description: "para relatórios, decisões e conformidade.",
