...
const steps = [
  {
    icon: Lightbulb,
    number: "01",
    title: "Entendimento do seu atendimento",
    description:
      "Você conta como funciona sua rotina hoje: canais, volume, equipe, principais dores.",
  ...
  },
  {
    ...
    description:
      "Um especialista em IA que já viveu atendimento & suporte desenha, junto com você, o fluxo ideal do agente.",
    color: "from-secondary to-secondary/60",
  },
  {
    icon: Zap,
    number: "03",
    title: "Implementação nas ferramentas que você já usa",
    description:
      "Conectamos o agente aos seus canais (WhatsApp, e-mail, site, CRM, etc.) e testamos com você.",
  ...
  },
  {
    ...
    description:
      "Medimos resultados, ajustamos respostas e fluxos e vamos refinando o agente conforme sua operação evolui.",
