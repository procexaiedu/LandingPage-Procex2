      ...
      <div className="container relative z-10 px-4">
        ...
        >
          ...
          <motion.h1 variants={itemVariants} className="text-4xl md:text-6xl font-display font-bold">
            Agentes de IA para
            <br />
            <span className="text-gradient-pink">Operações & Backoffice</span>
          </motion.h1>

          {/* Subtitle with main value proposition */}
          <motion.div variants={itemVariants} className="space-y-4">
            <p className="text-base md:text-lg font-semibold text-accent">
              que organizam o fluxo enquanto você toca o negócio
            </p>
            <p className="text-base md:text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Automatize status de pedidos, relatórios e organização de tarefas com agentes de IA desenhados por especialistas em operações.
            </p>
          </motion.div>
