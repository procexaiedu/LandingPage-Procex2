...
export function AttendanceSupportHero() {
      ...
      <div className="container relative z-10 px-4">
        ...
        >
          ...
          <motion.h1 variants={itemVariants} className="text-4xl md:text-6xl font-display font-bold">
            Agentes de IA para
            <br />
            <span className="text-gradient-amber">Atendimento & Suporte</span>
          </motion.h1>

          {/* Subtitle with main value proposition */}
          <motion.div variants={itemVariants} className="space-y-4">
            <p className="text-base md:text-lg font-semibold text-primary">
              que respondem com você, não no seu lugar
            </p>
            <p className="text-base md:text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Organize filas, responda mais rápido e não perca nenhuma demanda — com agentes de IA desenhados por especialistas em atendimento e suporte, na linguagem do seu negócio.
            </p>
          </motion.div>
